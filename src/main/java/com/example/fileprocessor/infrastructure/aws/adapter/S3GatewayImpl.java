package com.example.fileprocessor.infrastructure.aws.adapter;

import com.example.fileprocessor.domain.entity.SoapRequest;
import com.example.fileprocessor.domain.port.out.S3Gateway;
import com.example.fileprocessor.infrastructure.aws.config.S3Properties;
...
/**
 * AWS S3 implementation of S3Gateway.
 * Uploads documents to S3 bucket using async client.
 */
@Slf4j
@Component
