...
public class R2dbcCommunicationLogRepository implements CommunicationLogRepository {
    ...
    public Mono<CommunicationLog> save(CommunicationLog entry) {
        String sql = """
            INSERT INTO communication_log (trace_id, document_id, status, retry_count, error_code, filename, created_at)
        ...
        return databaseClient.sql(sql)
            ...
            .first()
            .thenReturn(entry)
            .doOnSuccess(saved -> log.info("Logged communication: traceId={}, documentId={}, status={}, retries={}",
