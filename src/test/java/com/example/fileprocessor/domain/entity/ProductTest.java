...
class ProductTest {
    ...
    void product_record_createsValidProduct() {
        ...
        Product product = new Product(null, "prod-1", "Test Product", LocalDateTime.now(), "ACTIVE", null, List.of(doc));
    ...
    void product_withEmptyDocuments() {
        Product product = new Product(null, "prod-1", "Empty Product", LocalDateTime.now(), "ACTIVE", null, List.of());
