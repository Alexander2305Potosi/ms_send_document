...
class SoapDocumentProcessingUseCaseTest {
    ...
    void setUp() {
        ...
        useCase = new SoapDocumentProcessingUseCase(productRepository, productRestGateway, soapGateway, historyRepository, validator, homologationRepository);
    ...
    void executePendingDocuments_whenValidationFails_emitsFailureResult() {
        ...
        useCase = new SoapDocumentProcessingUseCase(productRepository, productRestGateway, soapGateway, historyRepository, validatorWithPattern, homologationRepository);
    ...
    void executePendingDocuments_whenSizeExceedsLimit_emitsFailureResult() {
        ...
        useCase = new SoapDocumentProcessingUseCase(productRepository, productRestGateway, soapGateway, historyRepository, validatorWithSize, homologationRepository);
