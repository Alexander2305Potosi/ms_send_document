...
/**
 * Mock SOAP Server simple usando HttpServer built-in de Java.
 * No requiere dependencias externas.
 *
 * Ejecutar: java src/test/java/com/example/fileprocessor/mock/SimpleSoapMock.java
 * O: ./gradlew testClasses && java -cp build/classes/java/test build/classes/java/test/com/example/fileprocessor/mock/SimpleSoapMock.class
 */
public class SimpleSoapMock {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("========================================");
        System.out.println("SOAP Mock Server running on port 8081");
